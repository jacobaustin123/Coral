...
## %bb.3:                               ## %merge
	...
	.cfi_endproc
                                        ## -- End function
	.globl	_foo.5                  ## -- Begin function foo.5
	.p2align	4, 0x90
_foo.5:                                 ## @foo.5
	.cfi_startproc
## %bb.0:                               ## %entry
...
.zerofill __DATA,__common,_a,8,3
	.globl	_a.1                    ## @a.1
.zerofill __DATA,__common,_a.1,8,3
	.globl	_foo                    ## @foo
.zerofill __DATA,__common,_foo,8,3
	.globl	_i                      ## @i
.zerofill __DATA,__common,_i,8,3
	.globl	_i.2                    ## @i.2
.zerofill __DATA,__common,_i.2,8,3
	.globl	_l                      ## @l
.zerofill __DATA,__common,_l,8,3
	.globl	_l.3                    ## @l.3
.zerofill __DATA,__common,_l.3,8,3
	.globl	_x                      ## @x
